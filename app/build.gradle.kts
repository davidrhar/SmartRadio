...
dependencies {
    ...
    // Station favicon images in search results. Coil 3.x renamed its package
    // (coil3.* not coil.*) and requires picking a network engine explicitly —
    // using okhttp since it's already a dependency above.
